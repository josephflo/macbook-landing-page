...
Files: macbook-14.glb [629.72KB] > G:\repositories\macbook-landing-page\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export  default function DevMookModel14(props) {
  const {color } = useDevBookStore();
